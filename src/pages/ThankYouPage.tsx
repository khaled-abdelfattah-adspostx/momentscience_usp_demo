...
const ThankYouPage: React.FC = () => {
        ...
        campaigns: [
          {
            ...
            title: "Sample Offer",
            short_headline: "Get 50% Off",
            short_description: "Limited time offer",
            offer_description: "Save 50% on your next purchase with this exclusive offer",
            terms_and_conditions: "Valid for 30 days. Cannot be combined with other offers.",
            click_url: "https://example.com/offer",
            cta_yes: "Claim Now",
            cta_no: "No Thanks",
            mini_text: "Offer expires soon",
            image: "https://example.com/image.jpg",
            pixel: "",
            adv_pixel_url: "",
            save_for_later_url: "https://example.com/save",
  ...
  // Use webhook payload from state if available, otherwise create a simple summary
  const displayWebhookPayload = state.webhookPayload || {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 animate-slide-in-up">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-green-500 rounded-full mb-6 shadow-lg animate-scale-in">
            <svg className="w-10 h-10 text-white animate-checkmark-draw" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Summary Cards */}
        <div className="grid lg:grid-cols-2 gap-8 mb-8 animate-slide-in-up">
          
          {/* Order Summary Card */}
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-shadow duration-300 animate-slide-in-up">
