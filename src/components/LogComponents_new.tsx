  ...
  return (
    <div style={{ padding: '1.5rem', backgroundColor: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '0.75rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
        ...
        <h4 style={{ fontWeight: 600, color: '#111827', margin: 0 }}>Session Details</h4>
      </div>
      
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '0.75rem', fontWeight: 500, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.025em' }}>
            Session ID
          </div>
          <div style={{ fontSize: '0.875rem', fontWeight: 600, color: '#1f2937', fontFamily: 'Consolas, Monaco, "Courier New", monospace' }}>
            {sessionId || 'N/A'}
          </div>
        </div>
        <div style={{ textAlign: 'center' }}>
